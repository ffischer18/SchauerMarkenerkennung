...
namespace MarkenLib
{
    public class MarkenContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                string connectionString = @"server=(LocalDB)\mssqllocaldb;attachdbfilename=C:\Temp\Ohrmarken.mdf;database=Ohrmarken1;integrated security=True;MultipleActiveResultSets=True;";
